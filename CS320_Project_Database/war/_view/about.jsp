...
<p>CS 320 - Software Engineering and Design
Spring 2021

Class times (All Online):

Section 101: M-W-F 9:00 - 9:50 AM
Section 103: M-W-F 2:00 - 2:50 PM
Instructor:

[Krishna Kambhampaty], kkambhampaty@ycp.edu,
Office Hours: M-W-F 10:00-11:30 and by appointment
Course Description
...
Individual project, labs, and assignments: 30% (†)
Contributions to team project: 50% (*)
Midterm exam: 15%
Attendance and participation: 5%
(†) You must make a good faith effort to complete all of the labs and assignments. Failure to submit a good faith attempt for any assignment or lab is grounds for receiving a reduced grade for the course. Labs will be graded on a Pass / Fail basis. In order to receive a passing grade on a lab, your submission must have a substantial portion of the lab implemented and correctly working. You will be penalized up to 10% points off your course grade for each lab for which you do not receive a passing grade.
...
Course website
Please check the course web page, http://ycpcs.github.io/cs320-spring2021/, regularly for important announcements.
...
For example, if you have 5 unexcused absences, then your course grade could be reduced by as much as 2(5-2) = 8 points.
...
Reading Assignments
Reading assignments are posted on the Schedule page.
...
Assignments and labs will be posted as zip files on the course web page, http://ycpcs.github.io/cs320-spring2021/.
